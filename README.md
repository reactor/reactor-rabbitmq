...
[![Build Status](https://travis-ci.com/reactor/reactor-rabbitmq.svg?branch=master)](https://travis-ci.com/reactor/reactor-rabbitmq)
...
```groovy
dependencies {
  compile "io.projectreactor.rabbitmq:reactor-rabbitmq:1.4.2.RELEASE"
}
```
...
dependencies {
  compile "io.projectreactor.rabbitmq:reactor-rabbitmq:1.4.3.BUILD-SNAPSHOT"
}
```

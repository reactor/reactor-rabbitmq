...
```groovy
dependencies {
  compile "io.projectreactor.rabbitmq:reactor-rabbitmq:1.4.8.RELEASE"
}
```
...
<dependency>
    <groupId>io.projectreactor.rabbitmq</groupId>
    <artifactId>reactor-rabbitmq</artifactId>
    <version>1.4.9.BUILD-SNAPSHOT</version>
</dependency>
...
dependencies {
  compile "io.projectreactor.rabbitmq:reactor-rabbitmq:1.4.9.BUILD-SNAPSHOT"
}
```
